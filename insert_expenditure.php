...
?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">
                            ...
                            <i class="fa fa-money fa-fw"></i> Expenditure
                        ...
                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="submit" value="Add Expenditure" type="submit" class="btn btn-primary form-control">
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert_balance = "insert into balance (expenditure,date,e_name,e_purpose) values ('$amount','$date','$name','$purpose')";
        $run_balance = mysqli_query($con, $insert_balance);

        if ($run_product) {

            echo "<script>alert('New Expenditure added sucessfully')</script>";
