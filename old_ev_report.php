...
$view_report = "select * from old_ev_report order by 1 desc";
        ...
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    ...
                    <i class="fa fa-dashboard"></i> Dashboard / Old Ev Battery Stock Report
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    if (!isset($_POST['filter'])) {
                                        ...
                                        $view_report = "select * from old_ev_report";
                                    ...
                                    ?>
                                        ...
                                        $view_report = "select * from old_ev_report where date between '$from_date' and '$to_date'";
                                        $run_report = mysqli_query($con, $view_report);
