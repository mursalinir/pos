        ...
        if (isset($_POST['sale'])) {
            ...
            if($exchange==2)
            {
                ...
                $purpose=$qty . ' Pcs ' . $old_bat_name . ' Purchase (' . $invoice . ' )';
                    ...
                    $insert_balance = "insert into balance (expenditure,date,purpose) values ('$old_bat_price','$order_date','$invoice')";
            ...
            $details = $qty . ' Pcs ' . $product_name;
            $insert_a = "INSERT into amount (invoice,customer_id,total,paid,due,order_date,details) values ('$invoice','$customer_type','$total','$paid','$due','$order_date','$details')";
            ...
            while ($row_cart = mysqli_fetch_array($run_cart)) {
                ...
                $insert_sales = "INSERT INTO sales(invoice,product_id,product_serial,product_qty,purchase_rate,unit_price,customer_name,author_id,order_date,customer_contact,customer_city,customer_type,customer_address,product_category,sub_total,profit,easy_bike,battery,details,old_bat_price) VALUES('$invoice','$product_id','$product_serial','$product_qty','$purchase_rate','$unit_price','$customer_name','$author_id','$order_date','$customer_contact','$customer_city','$customer_type','$customer_address','$product_category','$total_price','$profit','$easybike','$battery','$details','$old_bat_price')";
