...
<?php 
    ...
    if(isset($_GET['edit_product'])){
        ...
        $cat = $row_edit['product_cat'];
        
        $p_image1 = $row_edit['product_img'];

        $p_desc = $row_edit['product_details'];
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="product_img1" type="file" class="form-control" value = "<?php echo $p_image1; ?>" >
...
if(isset($_POST['update'])){
    ...
    $update_product = "update products set product_cat='$cat',date=NOW(),product_name='$product_title',product_img='$product_img1',product_details='$product_desc' where product_id='$p_id'";
