                            ...
                            <table class="table table-striped table-bordered table-hover" id="table">
                                ...
                                <tbody id="income">
                                    ...
                                    if (!isset($_POST['filter'])) {
                                        ...
                                        $view_report = "select * from balance where income>0 order by date desc LIMIT 30";
                                    ...
                                    ?>
                                        ...
                                        $view_report = "select * from balance where income>0 and date between '$from_date' and '$to_date' order by date desc LIMIT 30";
                                        $run_report = mysqli_query($con, $view_report);
            ...
            <div class="col-md-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <h4 style="text-align: center; color:darkslategrey"> Total Income: </h4>
                        <h4 style="text-align: center; color:brown"> <?php echo $total_income; ?> Tk</h4>
...
?>
    ...
    <!-- script for dynamic incone load-->
    <script>
        $(document).ready(function() {
            var count = 30;
            $('#load').click(function() {
                count = count + 30;
                $("#income").load("load_income.php", {
                    newCount: count
                });
                return false;
            });
